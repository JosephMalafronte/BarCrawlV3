...
var PopupComponent = /** @class */ (function () {
    function PopupComponent(mainService, authService) {
        this.mainService = mainService;
        this.authService = authService;
        //Cover Variables
        this.showCoverPopUp = false;
    ...
    PopupComponent.prototype.ngOnInit = function () {
        ...
        this.mainService.showFriendPopUp.subscribe(function (value) {
            if (value == true) {
                ...
                _this.isRequestOut = false;
                _this.isRequestIn = false;
                console.log(_this.authService.currentUser.friendRequestIn);
                console.log(_this.friendUser.uid);
                //If user is friend activate friend mode
                if (_this.authService.currentUser.friendIds.indexOf(_this.friendUser.uid) > -1) {
                    _this.isFriend = true;
                }
                else {
                    // if user is request activate request mode
                    if (_this.authService.currentUser.friendRequestOut.indexOf(_this.friendUser.uid) > -1) {
                        _this.isRequestOut = true;
                    }
                    else { // if user is request in activate
                        if (_this.authService.currentUser.friendRequestIn.indexOf(_this.friendUser.uid) > -1)
...
var AuthService = /** @class */ (function () {
    function AuthService(dbA, afAuth) {
        ...
        this.loadingFriendData = new rxjs__WEBPACK_IMPORTED_MODULE_5__["BehaviorSubject"](true);
        this.subUser = false;
        this.af = afAuth;
        this.db = dbA;
        this.authStateSet = new rxjs__WEBPACK_IMPORTED_MODULE_5__["BehaviorSubject"](true);
    }
    ...
    AuthService.prototype.reloadFriendData = function () {
        ...
        this.db.list('userInfo/' + this.currentUser.uid + '/friends').valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1)).subscribe(function (data) {
            ...
            console.log(_this.currentUser.friendIds);
            _this.loadAllUserFriendData();
        });
    };
    ...
    AuthService.prototype.listenForFriendRequest = function () {
        ...
        this.db.object('/userInfo/' + this.currentUser.uid + '/friendRequestIn').valueChanges().subscribe(function (object) {
            ...
            console.log(_this.currentUser.friendRequestIn);
        });
    };
