...
module.exports = ".bottomButtons {\n    margin-top:0px;\n    padding-bottom: 100px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MainScrollComponent = /** @class */ (function () {
    function MainScrollComponent(dbA, authService, dateDirective) {
        this.authService = authService;
        ...
        this.barCards = [];
        this.allBarCards = [];
        this.cardsPerPage = 7; //Hardcoded value by preference
        this.curPage = 1;
        this.maxPage = 1;
        this.db = dbA;
    }
    ...
    MainScrollComponent.prototype.getBarCards = function () {
        ...
        this.db.list('barCards/' + this.dayOfTheWeek).valueChanges().subscribe(function (result) {
            _this.allBarCards = result;
            _this.allBarCards = _this.allBarCards.sort(function (a, b) {
                return a.orderRank - b.orderRank;
            });
            _this.maxPage = Math.ceil(_this.allBarCards.length / _this.cardsPerPage);
            _this.pageChange(1);
        });
    };
    MainScrollComponent.prototype.pageChange = function (pageNum) {
...
module.exports = "\n.navbarNewIphone{\n    margin-bottom: constant(safe-area-inset-bottom); \n    margin-bottom: calc(env(safe-area-inset-bottom) - 25px);\n}\n\n\n@media only screen \n    and (width : 375px) \n    and (height : 812px)\n    and (orientation : portrait)  \n    and (-webkit-device-pixel-ratio : 3) { \n\n        .navbarIphoneX{\n            margin-bottom: calc(env(safe-area-inset-bottom) - 25px);\n        }\n    }\n\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "\n.center-screen {\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    text-align: center;\n    min-height: 100vh;\n  }\n\n\n\n.circle-loader {\n    margin-bottom: 0;\n    border: 3px solid rgba(0, 0, 0, 0.2);\n    border-left-color: #F2C843;\n    -webkit-animation: loader-spin 1.2s infinite linear;\n            animation: loader-spin 1.2s infinite linear;\n    position: relative;\n    display: inline-block;\n    vertical-align: top;\n    border-radius: 50%;\n    width: 7em;\n    height: 7em;\n  }\n\n\n\n.load-complete {\n    -webkit-animation: none;\n    animation: none;\n    border-color: #F2C843;\n    transition: border 500ms ease-out;\n  }\n\n\n\n.checkmarkHidden {\n    display: none;\n  }\n\n\n\n.checkmark{\n    display:auto;\n  }\n\n\n\n.checkmark.draw:after {\n    -webkit-animation-duration: 800ms;\n            animation-duration: 800ms;\n    -webkit-animation-timing-function: ease;\n            animation-timing-function: ease;\n    -webkit-animation-name: checkmark;\n            animation-name: checkmark;\n    -webkit-transform: scaleX(-1) rotate(135deg);\n            transform: scaleX(-1) rotate(135deg);\n  }\n\n\n\n.checkmark:after {\n    opacity: 1;\n    height: 3.5em;\n    width: 1.75em;\n    -webkit-transform-origin: left top;\n            transform-origin: left top;\n    border-right: 4px solid #F2C843;\n    border-top: 4px solid #F2C843;\n    content: '';\n    left: 1.75em;\n    top: 3.5em;\n    position: absolute;\n  }\n\n\n\n@-webkit-keyframes loader-spin {\n    0% {\n        -webkit-transform: rotate(0deg);\n                transform: rotate(0deg);\n   }\n    100% {\n        -webkit-transform: rotate(360deg);\n                transform: rotate(360deg);\n   }\n  }\n\n\n\n@keyframes loader-spin {\n    0% {\n        -webkit-transform: rotate(0deg);\n                transform: rotate(0deg);\n   }\n    100% {\n        -webkit-transform: rotate(360deg);\n                transform: rotate(360deg);\n   }\n  }\n\n\n\n@-webkit-keyframes checkmark {\n    0% {\n        height: 0;\n        width: 0;\n        opacity: 1;\n   }\n    20% {\n        height: 0;\n        width: 1.75em;\n        opacity: 1;\n   }\n    40% {\n        height: 3.5em;\n        width: 1.75em;\n        opacity: 1;\n   }\n    100% {\n        height: 3.5em;\n        width: 1.75em;\n        opacity: 1;\n   }\n  }\n\n\n\n@keyframes checkmark {\n    0% {\n        height: 0;\n        width: 0;\n        opacity: 1;\n   }\n    20% {\n        height: 0;\n        width: 1.75em;\n        opacity: 1;\n   }\n    40% {\n        height: 3.5em;\n        width: 1.75em;\n        opacity: 1;\n   }\n    100% {\n        height: 3.5em;\n        width: 1.75em;\n        opacity: 1;\n   }\n  }\n\n\n\n.collapse {\n    display: none;\n  }\n\n\n\n.collapsing {\n    position: relative;\n    height: 0;\n    overflow: hidden;\n    padding: 0 0 0 0;\n    transition-property: height, visibility;\n    transition-duration: 0.35s;\n    transition-timing-function: ease;\n  }\n\n\n\n.show {\n    display: block !important;\n  }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _services_main_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../_services/main.service */ "./src/app/_services/main.service.ts");
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(authService, router, mainService) {
        this.authService = authService;
        this.router = router;
        this.mainService = mainService;
        this.logInUsername = "";
    ...
    LoginComponent.prototype.logIn = function () {
        ...
        this.authService.logIn(this.logInUsername, this.logInPassword).then(function (success) {
            ...
            if (err.code == "auth/invalid-email") {
                _this.logInError = "The email address is improperly formatted";
            }
            else if (err.code == "auth/wrong-password") {
                _this.logInError = "Incorrect username or password";
            }
            else {
                _this.logInError = "Error logging in";
            }
        });
    };
    ...
    LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"],
            _services_main_service__WEBPACK_IMPORTED_MODULE_6__["MainService"]])
    ], LoginComponent);
...
var SettingsComponent = /** @class */ (function () {
    ...
    SettingsComponent.prototype.submitBarSuggestion = function () {
        var _this = this;
        this.isLoading = true;
...
var AuthService = /** @class */ (function () {
    function AuthService(mainService, dbA, afAuth, router) {
        this.mainService = mainService;
        this.afAuth = afAuth;
        this.router = router;
    ...
    AuthService.prototype.restartApplication = function () {
    ...
    AuthService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_main_service__WEBPACK_IMPORTED_MODULE_7__["MainService"], _angular_fire_database__WEBPACK_IMPORTED_MODULE_3__["AngularFireDatabase"], angularfire2_auth__WEBPACK_IMPORTED_MODULE_2__["AngularFireAuth"], _angular_router__WEBPACK_IMPORTED_MODULE_8__["Router"]])
    ], AuthService);
    return AuthService;
}());
...
var MainService = /** @class */ (function () {
    ...
    MainService.prototype.setIphoneScreen = function () {
        this.iphoneHeight = window.screen.height;
        if (this.iphoneHeight == 896)
            this.iphoneVersion = "new";
        else if (this.iphoneHeight == 812)
            this.iphoneVersion = "new";
    };
...
module.exports = "html {\n    background-color: green;\n  }\n  \nbody {\n    background: linear-gradient(to bottom, #8BC63E 50%, #EEEEEE 50%);\n}\n  \n@media only screen \n    and (width : 375px) \n    and (height : 812px)\n    and (orientation : portrait)  \n    and (-webkit-device-pixel-ratio : 3) { \n\n        .iphoneXBlock{\n            width:100%; height:50px; top:0px; position: fixed; z-index: 150000; background-color: black;\n        }\n    }\n\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<div id=\"newiPhoneHeader\" class=\"newiPhoneHeader\"></div>\n\n<router-outlet></router-outlet>\n"
